...
Route::group(['middleware' => ['auth:prajuru', 'ceklevel:prajuru,kelian_tempekan']], function () {
    ...
    Route::get('kwitansi1/{id} ', [TransaksiController::class, 'kwitansi1'])->name('kwitansi1');
    ...
    Route::get('krama-export', [KramaController::class, 'kramaExport'])->name('krama.export');
    Route::post('krama-import', [KramaController::class, 'kramaImport'])->name('krama.import');
    Route::get('form-import', [KramaController::class, 'formImport'])->name('form.import');
});
